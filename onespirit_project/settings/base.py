"""
Base settings for onespirit_project.
...
MIDDLEWARE = [
    ...
    # Tenant-aware middleware (must come after authentication)
    'accounts.middleware.TenantContextMiddleware',
    'accounts.middleware.AdminTenantContextMiddleware',
    'accounts.middleware.TenantAccessControlMiddleware',
...
WSGI_APPLICATION = 'onespirit_project.wsgi.application'
